...
#
# Q-S7-35T-SkyTracker.tcl: Tcl script for re-creating project 'Cmod-A7-35T-XADC'
#
...
#
# 1. This project restoration tcl script (Q-S7-35T-SkyTracker.tcl) that was generated.
#
...
set _xil_proj_name_ "Q-S7-35T-reference"
...
set script_file "Q-S7-35T-reference.tcl"
...
set files [list \
 ...
 [file normalize "${origin_dir}/hdl/top_reference.vhd" ]\
]
...
set file "hdl/top_reference.vhd"
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "VHDL" -objects $file_obj
set_property -name "is_enabled" -value "1" -objects $file_obj
set_property -name "is_global_include" -value "0" -objects $file_obj
...
set_property -name "top" -value "top_reference" -objects $obj
...
set file "[file normalize ${origin_dir}/constraints/QS7_pinmap.xdc]"
set file_imported [import_files -fileset constrs_1 [list $file]]
set file "constraints/QS7_pinmap.xdc"
...
if {[string equal [get_runs -quiet synth_1] ""]} {
    create_run -name synth_1 -part xc7s15ftgb196-1 -flow {Vivado Synthesis 2020} -strategy "Flow_PerfOptimized_high" -report_strategy {No Reports} -constrset constrs_1
} else {
...
if {[string equal [get_runs -quiet impl_1] ""]} {
    create_run -name impl_1 -part xc7s15ftgb196-1 -flow {Vivado Implementation 2020} -strategy "Performance_NetDelay_high" -report_strategy {No Reports} -constrset constrs_1 -parent_run synth_1
} else {
